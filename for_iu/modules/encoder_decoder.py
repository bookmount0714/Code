...
class Transformer(nn.Module):
    ...
    def forward(self,src, src_sam, tgt, src_mask, graph_feature,graph_feature_ground,images_id,result,top_3_values,tgt_mask,tokenizer,att_feats_384,att_feats_41,batch_report_labels,original_lengths_tensor,original_lengths_tensor_ground):
        ...
        for i in range(result.shape[0]):
            ...
            first_reports.append(globals_ele.reports[report_indices[0]])  # 第一个下标对应的报告
            second_reports.append(globals_ele.reports[report_indices[1]])  # 第二个下标对应的报告
            third_reports.append(globals_ele.reports[report_indices[2]])  # 第三个下标对应的报告
        ...
        for i, image_id in enumerate(images_id):
            ...
            index = result[i,:]
            predicted_tensor_1 = globals_ele.reports_tensor[index[0]]
            predicted_tensor_2 = globals_ele.reports_tensor[index[1]]
            predicted_tensor_3 = globals_ele.reports_tensor[index[2]]
