...
def parse_agrs():
    ...
    parser.add_argument('--image_dir', type=str, default='/data1/liuyuxue/Data/mimic_cxr/images', help='the path to the directory containing the data.')
    parser.add_argument('--ann_path', type=str, default='/data1/lijunliang/r2gen/data/mimic/assited/newann_1.json', help='the path to the directory containing the data.')
    ...
    parser.add_argument('--log_dir', type=str, default='./records/log/',  help='whether to resume the training from existing checkpoints.')
...
def main():
    ...
    # #获取radgraph报告数据
    # globals_ele.radgraph_iu_data = get_json_data(iu_report_radgraph)


    #获取mimic的radgraph报告数据
    mimic_report_radgraph = '/data1/data/physionet.org/files/radgraph/1.0.0/MIMIC-CXR_graphs.json'
    globals_ele.radgraph_mimic_data = get_json_data(mimic_report_radgraph)
    ...
    # model_path = "./results/iu_xray/model_best.pth"
