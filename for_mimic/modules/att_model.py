...
class AttModel(CaptionModel):
    def __init__(self, args, tokenizer):
        ...
        #         (nn.Linear(4096, self.input_encoding_size),
        #          nn.ReLU(),
    ...
    def _prepare_feature(self, fc_feats , fc_feats_sam , att_feats,att_feats_sam ,att_masks,graph_feature,result,top_3_values,tokenizer):
    ...
    def _sample_beam(self, fc_feats, fc_feats_sam,att_feats, att_feats_sam ,graph_feature,result, top_3_values,tokenizer,original_lengths_tensor,att_masks=None, opt={}):
        ...
        p_fc_feats, p_att_feats, pp_att_feats, p_att_masks = self._prepare_feature(fc_feats, fc_feats_sam ,att_feats, att_feats_sam ,att_masks,graph_feature,result,top_3_values,tokenizer,original_lengths_tensor)
    ...
    def _sample(self, fc_feats, fc_feats_sam ,att_feats, att_feats_sam,graph_feature,result,top_3_values,tokenizer,original_lengths_tensor,att_masks=None):
        ...
        if beam_size > 1 and sample_method in ['greedy', 'beam_search']:
            return self._sample_beam(fc_feats, fc_feats_sam ,att_feats, att_feats_sam,graph_feature,result,top_3_values,tokenizer,original_lengths_tensor ,att_masks, opt)
        if group_size > 1:
