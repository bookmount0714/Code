...
from mia.SubLayers import MultiHeadAttention, PositionwiseFeedForward
...
class RefineVisualLayer(nn.Module):
    ...
    def forward(self, T, V,G):
        ...
        Refine_V = self.enc_attn( V, T, T )
        Refine_V = self.cross_attn(V,G,G)
